...
(2) Test building arguements
(3) Test predictions, variance estimation, and sampling.
(4) Run single iteration of select acquisition function.
"""
...
# Test predicted mean and variance, sampling
...
def test_BO_autobuild_full_resolve():
    assert BO_pred('TS', build_type='spec', return_='none')
    
def test_BO_autobuild_external():
    assert BO_pred('TS', build_type='external', return_='none')
